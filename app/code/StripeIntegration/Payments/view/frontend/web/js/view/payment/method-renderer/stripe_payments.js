        ...
        return Component.extend({
            ...
            getApplePayParams: function()
            {
                ...
                if (this.config().useStoreCurrency)
                {
                    ...
                    // We are adding the tax because of https://github.com/magento/magento2/issues/7769#issuecomment-369063612
                    amount = parseFloat(quote.totals().grand_total) + parseFloat(quote.totals().tax_amount);
                }
                else
                {
