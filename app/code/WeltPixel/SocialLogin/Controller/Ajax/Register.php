...
class Register extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        try {
            $customerData = $this->helper->jsonDecode($this->getRequest()->getContent());
        } catch (\Exception $e) {
            return $resultRaw->setHttpResponseCode($httpBadRequestCode);
        }
        if (!$customerData || !$this->getRequest()->isPost() || !$this->getRequest()->isXmlHttpRequest()) {
            return $resultRaw->setHttpResponseCode($httpBadRequestCode);
        }
        ...
        try {
            ...
            $confirmation = $customerData['password_confirmation'];
            ...
            $response = [
                'errors' => true,
                'message' => $this->escaper->escapeHtml($this->escaper->escapeHtml($e->getMessage()))
            ];
