...
use \WeltPixel\SocialLogin\lib\Google\Config as Google_Config;
use \WeltPixel\SocialLogin\lib\Google\Auth\GoogleAuthAbstract as Google_Auth_Abstract;
use \WeltPixel\SocialLogin\lib\Google\Auth\OAuth2 as Google_Auth_OAuth2;
use \WeltPixel\SocialLogin\lib\Google\IO\Curl as Google_IO_Curl;
use \WeltPixel\SocialLogin\lib\Google\IO\GoogleIOAbstract as Google_IO_Abstract;
use \WeltPixel\SocialLogin\lib\Google\Logger\GoogleLoggerAbstract as Google_Logger_Abstract;
use \WeltPixel\SocialLogin\lib\Google\Http\Request as Google_Http_Request;
use \WeltPixel\SocialLogin\lib\Google\Exception as Google_Exception;
...
class Client
{
  ...
  public function __construct($config = null)
  {
    ...
    if ($config->getIoClass() == Google_Config::USE_AUTO_IO_SELECTION) {
      if (function_exists('curl_version') && function_exists('curl_exec')
          && !$this->isAppEngine()) {
        $config->setIoClass("WeltPixel\SocialLogin\lib\Google\IO\Curl");
      } else {
  ...
  /**
   * @return GoogleLoggerAbstract Logger implementation
   */
