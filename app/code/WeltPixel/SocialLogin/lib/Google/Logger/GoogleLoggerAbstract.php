<?php
namespace WeltPixel\SocialLogin\lib\Google\Logger;

use WeltPixel\SocialLogin\lib\Google\Client as Google_Client;
use WeltPixel\SocialLogin\lib\Google\Logger\Exception as Google_Logger_Exception;
/*
 ...
 */
abstract class GoogleLoggerAbstract
{
  /**
   * Default log format
   */
