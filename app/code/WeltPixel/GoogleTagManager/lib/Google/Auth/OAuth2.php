<?php
namespace WeltPixel\GoogleTagManager\lib\Google\Auth;
...
use WeltPixel\GoogleTagManager\lib\Google\Auth\Exception as Google_Auth_Exception;
/*
 ...
 *
 */
class OAuth2 extends GoogleAuthAbstract
{
  ...
  public function createAuthUrl($scope)
  {
    ...
    $scopePos = strpos($scope, 'plus.login');
    if ($scopePos && strlen($rva) > 0) {
