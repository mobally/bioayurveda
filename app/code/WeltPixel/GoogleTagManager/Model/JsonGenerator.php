...
class JsonGenerator extends \Magento\Framework\Model\AbstractModel
{
    ...
    public function generateItemJson(
        ...
        $this->displayAdvertising = (boolean)$displayAdvertising;
    ...
    {
        $variablesToCreate = $this->apiCore->getVariablesList($this->uaTrackingId, $this->apiParams);
    ...
    public function getTagsForJsonGeneration($triggers)
    {
        ...
        $tagsToCreate = $this->apiCore->getTagsList($this->ipAnonymization, $this->displayAdvertising, $this->apiParams, $triggersMap);
