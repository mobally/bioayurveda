...
class Head {
        ...
        \Magento\Framework\View\Layout\Element $headElement)
    {
        ...
        if ($this->utilityHelper->isPearlThemeUsed()) {
            ...
            $categoryStoreCss = 'weltpixel_custom_footer_' . $store->getData('code') . '.css';

            $node = new \Magento\Framework\View\Layout\Element('<css src="WeltPixel_CustomFooter::css/' . $categoryStoreCss . '" />');
