<?php
namespace WeltPixel\ProductLabels\Block\Adminhtml\ProductLabels\Edit\Tab;
...
class Conditions extends Generic implements TabInterface
{
    ...
    {
        $model = $this->_coreRegistry->registry('weltpixel_productlabel');
     ...
     */
    protected function addTabToForm($model, $fieldsetId = 'conditions_fieldset', $formName = 'weltpixelproductlabels_productlabels_form')
    {
        /** @var \Magento\Framework\Data\Form $form */
