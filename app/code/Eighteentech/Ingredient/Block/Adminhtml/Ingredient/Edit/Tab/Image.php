    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $form = $this->_formFactory->create(['data' => ['html_id_prefix' => 'ingredient_image_']]);
        ...
        $this->_eventManager->dispatch('adminhtml_ingredient_edit_tab_image_prepare_form', ['form' => $form]);
        $ingredientData = array();
        if(count($model->getData())){
			$ingredientData = $model->getData();
			$ingredientData['image'] = 'ingredient/'.$ingredientData['image'];
		}

        $form->setValues($ingredientData);
    ...
    {
        return ['image' => 'Eighteentech\Ingredient\Block\Adminhtml\Form\Element\Image'];
    }
}
