<?php
/**
 * Ingredient data helper
 */
namespace Eighteentech\Ingredient\Helper;
...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
     ...
     * @var string
     */
    const XML_PATH_ENABLED            = 'ingredient/view/enabled';

    /**
     * Path to store config where count of Ingredient posts per page is stored
     *
     * @var string
     */
    const XML_PATH_ITEMS_PER_PAGE     = 'ingredient/view/items_per_page';

    /**
     * Path to store config where count of days while Ingredient is still recently added is stored
     *
     * @var string
     */
    const XML_PATH_DAYS_DIFFERENCE    = 'ingredient/view/days_difference';
    ...
    /**
     * Remove Ingredient item image by image filename
     *
    ...
    /**
     * Return URL for resized Ingredient Item Image
     *
     * @param Magentostudy_Ingredient_Model_Item $item
     * @param integer $width
     * @param integer $height
     * @return bool|string
     */
    public function resize(\Eighteentech\Ingredient\Model\Ingredient $item, $width, $height = null)
    {
        if (!$item->getImage()) {
            return false;
        }
    ...
    /**
     * Return the base media directory for Ingredient Item images
     *
     * @return string
     */
    ...
    /**
     * Return the Base URL for Ingredient Item images
     *
     * @return string
     */
