<?php
/**
 * Certificate data helper
 */
namespace Eighteentech\Certificate\Helper;
...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
     ...
     * @var string
     */
    const XML_PATH_ENABLED            = 'certificate/view/enabled';

    /**
     * Path to store config where count of Certificate posts per page is stored
     *
     * @var string
     */
    const XML_PATH_ITEMS_PER_PAGE     = 'certificate/view/items_per_page';

    /**
     * Path to store config where count of days while Certificate is still recently added is stored
     *
     * @var string
     */
    const XML_PATH_DAYS_DIFFERENCE    = 'certificate/view/days_difference';
    ...
    /**
     * Remove Certificate item image by image filename
     *
    ...
    /**
     * Return URL for resized Certificate Item Image
     *
     * @param Magentostudy_Certificate_Model_Item $item
     * @param integer $width
     * @param integer $height
     * @return bool|string
     */
    public function resize(\Eighteentech\Certificate\Model\Certificate $item, $width, $height = null)
    {
        if (!$item->getImage()) {
            return false;
        }
    ...
    /**
     * Return the base media directory for Certificate Item images
     *
     * @return string
     */
    ...
    /**
     * Return the Base URL for Certificate Item images
     *
     * @return string
     */
