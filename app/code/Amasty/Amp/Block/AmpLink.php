...
{
    const AMP_CANONICAL_PRODUCT = 'am_amp_canonical_product';
    const AMP_CANONICAL_CATEGORY = 'am_amp_canonical_category';
    const AMP_CANONICAL_CMS = 'am_amp_canonical_cms';
    const AMP_CANONICAL_HOME = 'am_amp_canonical_home';
