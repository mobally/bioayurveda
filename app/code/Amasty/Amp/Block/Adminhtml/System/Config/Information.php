...
namespace Amasty\Amp\Block\Adminhtml\System\Config;
...
class Information extends \Magento\Config\Block\System\Config\Form\Fieldset
{
     ...
     * @var string
     */
    private $userGuide = 'https://amasty.com/docs/doku.php?id=magento_2:amp';
    ...
    public function getAdditionalModuleContent()
    {
        if (!class_exists(\Detection\MobileDetect::class)) {
            $result[] = [
                'type' => 'message-notice',
                'text' => __('We recommend using the 3rd-party library to improve the mobile detection algorithm. '
