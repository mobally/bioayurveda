...
class PostPluginTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testAfterExecute()
    {
        ...
        $message = $this->createPartialMock(\Magento\Framework\Message\Collection::class, ['getLastAddedMessage', 'getText']);
        ...
        $session->expects($this->once())->method('getData')->willReturn($message);
        $message->expects($this->once())->method('getLastAddedMessage')->willReturn($message);
