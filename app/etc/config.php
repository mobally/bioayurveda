...
return [
    'modules' => [
        ...
        'Eighteentech_Buynow' => 1,
        'Eighteentech_CategoryContent' => 1,
        'Eighteentech_Certificate' => 1,
        'Eighteentech_Core' => 1,
        'Eighteentech_Custom' => 1,
        'Eighteentech_Delegatedac' => 1,
        'Eighteentech_FooterSticky' => 1,
        'Eighteentech_Home' => 1,
        'Eighteentech_Ingredient' => 1,
        'Eighteentech_Instagram' => 1,
        'Eighteentech_Seo' => 1,
        'Eighteentech_ShippingNotification' => 1,
        'Klarna_Core' => 1,
        'Klarna_Ordermanagement' => 1,
        'Klarna_Kp' => 1,
        'Magento_PaypalReCaptcha' => 1,
        'MSP_TwoFactorAuth' => 1,
        'MagePal_LinkProduct' => 1,
        'Magecomp_Discountpercentage' => 1,
        'Magefan_Community' => 1,
        'Magefan_Blog' => 1,
        'Magefan_WysiwygAdvanced' => 1,
        'Mageplaza_Core' => 1,
        'Mageplaza_Smtp' => 1,
        'Meetanshi_IndianGst' => 1,
        'Meetanshi_RestrictZip' => 1,
        'One97_Paytm' => 1,
        'Razorpay_Magento' => 1,
        'Retail_Analytics' => 1,
        'Retail_Push' => 1,
        'Sparsh_MobileNumberLogin' => 1,
