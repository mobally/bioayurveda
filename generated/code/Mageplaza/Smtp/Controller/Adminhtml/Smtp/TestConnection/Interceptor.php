...
class Interceptor extends \Mageplaza\Smtp\Controller\Adminhtml\Smtp\TestConnection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Backend\App\Action\Context $context, \Mageplaza\Smtp\Helper\AbandonedCart $helperAbandonedCart)
    {
        $this->___init();
        parent::__construct($context, $helperAbandonedCart);
    }
