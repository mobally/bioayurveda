...
class Interceptor extends \Magento\SalesRule\Block\Adminhtml\Promo\Widget\Chooser implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Backend\Block\Template\Context $context, \Magento\Backend\Helper\Data $backendHelper, \Magento\SalesRule\Model\RuleFactory $ruleFactory, array $data = [])
    {
        $this->___init();
