...
class Interceptor extends \Magento\Vault\Block\Form implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Magento\Vault\Model\Ui\Adminhtml\TokensConfigProvider $tokensConfigProvider, \Magento\Payment\Model\CcConfigProvider $ccConfigProvider, array $data = [])
    {
        $this->___init();
