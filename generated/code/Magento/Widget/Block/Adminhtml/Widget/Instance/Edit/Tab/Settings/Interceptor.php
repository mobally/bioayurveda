...
class Interceptor extends \Magento\Widget\Block\Adminhtml\Widget\Instance\Edit\Tab\Settings implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTypesOptionsArray');
        if (!$pluginInfo) {
            return parent::getTypesOptionsArray();
        } else {
            return $this->___callPlugins('getTypesOptionsArray', func_get_args(), $pluginInfo);
        }
    }
