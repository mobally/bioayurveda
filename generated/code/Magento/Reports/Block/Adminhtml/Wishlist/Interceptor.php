...
class Interceptor extends \Magento\Reports\Block\Adminhtml\Wishlist implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Backend\Block\Template\Context $context, \Magento\Reports\Model\ResourceModel\Wishlist\CollectionFactory $wishlistFactory, array $data = [])
    {
        $this->___init();
