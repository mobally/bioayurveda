...
class Interceptor extends \Amazon\Payment\Block\ProductPagePaymentLink implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Amazon\Core\Helper\Data $coreHelper, \Amazon\Core\Helper\CategoryExclusion $categoryExclusionHelper, \Magento\Framework\Registry $registry, array $data = [])
    {
        $this->___init();
